...
function setRstate {
	...
	mv ran-capacity-management/build/feature-release.xml ran-capacity-management/build/feature-release.${rstate}.xml
...
function Arm104nexusDeploy {
	...
	ArtifactId=$module
	zipName=Ericsson-RAN-Capacity-Management-Analysis
	
	echo "****"	
	echo "Deploying the zip /$zipName-17B.zip as ${ArtifactId}${rstate}.zip to Nexus...."
